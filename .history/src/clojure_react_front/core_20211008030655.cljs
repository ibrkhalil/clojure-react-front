...
[:tbody
  ...
  [:th {:on-click #(let [old-data @data old-by-12-hr @by-12-hr] (reset! by-12-hr (if (= old-by-12-hr true) false true)) (reset! data (sort by-12-hr-fn old-data)) )} "temperature after 3 days"]

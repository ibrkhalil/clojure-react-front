...
[:tbody
  ...
  [:th {:on-click #(let [old-data @data old-temp @current-temp] (reset! current-temp (if (= old-temp true) false true)) (reset! data (sort by-12-hr old-data)) )} "temperature after 12 hours"]
